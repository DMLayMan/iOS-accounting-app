...
const base = path.resolve('evidence/time-icost');
const titles = {
  "01-statistics-icost": [
    "main",
    "统计 · 周期与年月分两行"
...
fs.writeFileSync(path.join(base, 'index.html'), `<!doctype html><html lang="zh-CN"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>余记 · iCost 时间栏</title>
...
<header><h1>时间栏按 iCost 参考落地。</h1><p>流水左侧显示年月，后接轻量前后箭头；统计上行选择周期，下行居中年月和前后按钮。两页共享期间，保留底部中间记账入口。</p><div class="links"><a href="../../docs/time-icost-2026-09-10.md">设计与验收记录</a><a href="../time-competitors/index.html">竞品研究</a><a href="screenshots.json">截图来源</a></div></header>
...
<main>${cards}</main><footer>原生模拟器截图，点击可放大；各图来自不同操作步骤。参考 iCost 官方原图的时间栏结构，保留余记配色及已支持的月/年/全部/范围。使用 2022–2026 年隔离样例，真机触觉与 VoiceOver 实际朗读尚未验收。</footer>
